...
require github.com/Psiphon-Labs/psiphon-tunnel-core v0.0.0-00010101000000-000000000000

require golang.org/x/exp/typeparams v0.0.0-20240119083558-1b970713d09a // indirect